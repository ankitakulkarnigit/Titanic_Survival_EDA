...
Original file is located at
    https://colab.research.google.com/drive/1IZgyuRi9VeNBDCZH78ARDngXk_9aMe_b
...
!git clone 'https://github.com/ankitakulkarnigit/Datasets.git'
...
# Create the profile
profile = ProfileReport(titanic_df, title="Titanic Data Profiling Report", explorative=True)
